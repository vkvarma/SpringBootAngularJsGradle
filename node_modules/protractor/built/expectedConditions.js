...
var ProtractorExpectedConditions = (function () {
    ...
    ProtractorExpectedConditions.prototype.alertIsPresent = function () {
        return function () {
            return ptor_1.protractor.browser.driver.switchTo().alert().then(function () { return true; }, function (err) {
    ...
    ProtractorExpectedConditions.prototype.titleContains = function (title) {
        return function () {
            return ptor_1.protractor.browser.driver.getTitle().then(function (actualTitle) {
    ...
    ProtractorExpectedConditions.prototype.titleIs = function (title) {
        return function () {
            return ptor_1.protractor.browser.driver.getTitle().then(function (actualTitle) { return actualTitle === title; });
        };
    };
    /**
    ...
    ProtractorExpectedConditions.prototype.urlContains = function (url) {
        return function () {
            return ptor_1.protractor.browser.driver.getCurrentUrl().then(function (actualUrl) {
    ...
    ProtractorExpectedConditions.prototype.urlIs = function (url) {
        return function () {
            return ptor_1.protractor.browser.driver.getCurrentUrl().then(function (actualUrl) { return actualUrl === url; });
        };
    };
    /**
