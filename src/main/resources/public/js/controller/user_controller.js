...
userController.controller('UserController', ['$scope', 'UserService',function($scope, UserService) {
	...
	$scope.deleteUser = function (identity) {
	    var user = UserService.get({id: identity}, function () {
...
/*App.controller('UserController', ['async', '$scope', 'UserService', function(async, $scope, UserService) {
    ...
    self.getPager = function(totalItems, currentPage, pageSize) {
        ...
        var pages = self.range(1, totalPages);
     ...
     self.setPage = function (page) {
        ...
        self.pager = self.getPager(self.pageItems.length, page);
        //self.pager = self.getPager(self.users.length, page);
        console.log(self.pager);
        // get current page of items
        self.users = self.pageItems.slice(self.pager.startIndex, self.pager.endIndex);
